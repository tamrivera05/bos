...
const logIn = () => {
  return (
    <div className="h-screen w-full flex-row items-center justify-center scroll-auto px-10 py-10 sm:flex lg:px-0 lg:py-0 lg:bg-[#1F2937]">
      ...
      <div className="hidden h-full w-1/2 flex-auto items-center justify-center lg:flex dark:border-l ">
        <div className="text-[7rem] font-extrabold text-white leading-none">
          Barangay
          <br />
          Online
          <br />
          Services
          <div className="pt-4 text-3xl font-normal text-white">Welcome back!</div>
        </div>
      </div>
